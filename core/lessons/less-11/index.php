...
THIS IS ELEVENTH LESSON
</div>
<br><br>
</div>
<div class="next"><a href="../less-12/">Next ></a></div>
<div class="home"><a href="../../../">Home</a></div>
<div class="prev"><a href="../less-10/">< Prev</a></div>
<div class="clear"></div>
<div class="body">
<br>
...
if((strpos($_GET['file'],"etc/passwd")!==false) || 
(strpos($_GET['file'],"/./")!==false)          || 
(strpos($_GET['file'],"..")!==false)){
echo "<br>THIS IS A HACKING ATTEMPT";
}elseif($_GET['file']=="mh.txt"){
echo "Ashiyane LFI Laboratory - Loaded File.";}
else{
echo "<br>NO VALID FILE";}

if(isset($_GET['file'])){
$d="../../file/".$_GET['file'];?>
<p hidden><?php include("$d")?> </p>
<?php
}
} 
?>
</div>
<div class="help"><a href="javascript:popUp('../../help/?lesson=11')">Help</a></div>
